...
Logging components is a only a matter of calling [`MsgSender::with_component`]() using any type that implements the [`Component` trait](). We provide [a few of those]().
