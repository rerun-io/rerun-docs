...
Clicking on the title of a Space View has the same effect as selecting it in the [Blueprint view](blueprint)
and will show additional information & settings in the [Selection view](selection) or other means.
