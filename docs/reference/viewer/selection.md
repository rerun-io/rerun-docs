...
including the [Blueprint](blueprint), [Viewport](viewport),
[Timeline](timeline), [Event Log](overview.md#event-log)
...
[Blueprint settings](blueprint) of an Entity in the context of a given Space View.
